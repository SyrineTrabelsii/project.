...
function ready(){
    ...
    var quantityInputs = document.getElementsByClassName('cart-quantity_input')
...
function addItemToCart(title, price, imageSrc){
    ...
    cartRow.getElementsByClassName('btn-danger')[0].addEventListener('click', removeCarItem)
